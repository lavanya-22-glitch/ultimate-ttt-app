#focused more on winning the big board rather than the smaller boards
...
def evaluate(board, player):
    ...
    # Step 1: Simulate mainboard from local wins
    ...
    for i in range(3):
        for j in range(3):
            ...
            # Position preference inside mini-board
            for r in range(3):
                for c in range(3):
                    cell = mini[r][c]
                    if cell == player:
